...
public class MedicineManagerIMPL implements IMedicineManager {
	...
	public ArrayList<Medicine> ListMedicineList() {
		...
		Medicine medicineOne = new Medicine("MED01", "A", 25, 1200);
		Medicine medicineTwo = new Medicine("MED02", "B", 40, 1400);
		Medicine medicineThree = new Medicine("MED03", "C", 50, 1400);
		Medicine medicineFour = new Medicine("MED04", "D", 60, 1600);
	...
	public void DeleteMedicine() {
		...
		for (Medicine medicine : ListMedicineList()) {
			if (medicine.getMedicineID().equals(Medicid)) {
				...
				System.out.println("Medicine removed succesfully ");
				System.out.println("");
	...
	public void DecreasemedicineQuantity() {
		...
		System.out.println("Enter medicine id to Descrease medicine quantity: ");
		String Medicid = scanner.nextLine();
		boolean Isright = true;
		for (Medicine medicine : ListMedicineList()) {
			if (medicine.getMedicineID().equals(Medicid)) {
				...
				while (Isright) {
					...
					if (Isright) {
						...
						System.out.println("Can't Decreased more than original quantity from Type  " + medicine.getMedicineType());
						Isright = true;
					}
				}
			}
